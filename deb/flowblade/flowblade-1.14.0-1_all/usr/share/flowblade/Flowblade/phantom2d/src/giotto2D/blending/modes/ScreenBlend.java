...
public class ScreenBlend extends AbstractBlender
{
				...
				Rectangle blendArea )
	{
		...
		for( i = xStart; i < xEnd; i++ )
		{
			for( j = yStart; j < yEnd; j++ )
			{
				...
				//--- Do blend
				///1 - (1-a) * (1-b)
				rVal = 255 - ( ( ( 255 - sPixel[ RED ] ) * ( 255 - dPixel[ RED ] ) ) / 255 );

				gVal = 255 - ( ( ( 255 - sPixel[ GREEN ] ) * ( 255 - dPixel[ GREEN ] ) ) / 255 );

				bVal = 255 - ( ( ( 255 - sPixel[ BLUE ] ) * ( 255 - dPixel[ BLUE ] ) ) / 255 );
