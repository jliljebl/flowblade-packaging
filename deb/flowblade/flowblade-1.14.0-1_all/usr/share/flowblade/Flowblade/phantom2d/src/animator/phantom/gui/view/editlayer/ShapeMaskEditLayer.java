...
public class ShapeMaskEditLayer extends AnchorRectEditLayer
{

	public ShapeMaskEditLayer( ShapeMaskPlugin plugin )
	{
		super( plugin.getIOP(), new Rectangle( 0,0,ShapeMaskPlugin.WIDTH, ShapeMaskPlugin.HEIGHT ) );
		name = plugin.getIOP().getName();
	}

	public ShapeMaskEditLayer( ShapeMergePlugin plugin )
	{
		super( plugin.getIOP(), new Rectangle( 0,0,ShapeMaskPlugin.WIDTH, ShapeMaskPlugin.HEIGHT ) );
		name = plugin.getIOP().getName();
	}
