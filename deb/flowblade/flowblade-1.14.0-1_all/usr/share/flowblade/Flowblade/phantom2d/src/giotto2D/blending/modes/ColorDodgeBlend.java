...
public class ColorDodgeBlend extends AbstractBlender
{
		...
		for( i = xStart; i < xEnd; i++ )
		{
			for( j = yStart; j < yEnd; j++ )
			{
				...
				if( sPixel[ RED ] == 255 )
					...
					rVal = dPixel[ RED ] * 255 / ( 255 - sPixel[ RED ]);
				...
				if( sPixel[ GREEN ] == 255 )
					...
					gVal = dPixel[ GREEN ]  * 255 / ( 255 - sPixel[ GREEN ]);
				...
				if( sPixel[ BLUE ] == 255 )
					...
					bVal = dPixel[ BLUE ]  * 255 / ( 255 - sPixel[ BLUE ]);
