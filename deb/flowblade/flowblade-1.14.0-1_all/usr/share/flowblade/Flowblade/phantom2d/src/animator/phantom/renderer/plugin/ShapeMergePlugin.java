...
import animator.phantom.gui.view.editlayer.ShapeMaskEditLayer;
...
public class ShapeMergePlugin extends PhantomPlugin
{
	...
	public void renderMask( float frame, Graphics2D maskGraphics, int canvasWidth, int canvasHeight )
	{
		...
		GTTObject mask;
		if( shapeType.get() == 0 ) mask = new GTTRectangle( WIDTH, HEIGHT );
		else mask = new GTTOval( WIDTH, HEIGHT );
