...
//import animator.phantom.renderer.imagesource.ShapeIOP;

public class ShapeEditLayer extends AnchorRectEditLayer
{

	public ShapeEditLayer( ShapePlugin plugin )
	{
		super( plugin.getIOP(), new Rectangle( 0,0,ShapePlugin.WIDTH, ShapePlugin.HEIGHT ) );
